...
R is interpreted (not compiled) and mixed structural and object-oriented language. More specifically, R is referred to as a procedural programing langauge for its use of functions of simple computational steps.
